...
import (
	...
	"go-cs/internal/utils/es/uritemplates"
)
...
// NewSearch creates a new service for searching in Elasticsearch.
...
func (s *Search) Pretty(pretty bool) *Search {
	s.pretty = &pretty
	return s
}
...
func (s *Search) Human(human bool) *Search {
	s.human = &human
	return s
}

// ErrorTrace specifies whether to include the stack trace of returned errors.
func (s *Search) ErrorTrace(errorTrace bool) *Search {
	s.errorTrace = &errorTrace
	return s
}

// FilterPath specifies a list of filters used to reduce the response.
func (s *Search) FilterPath(filterPath ...string) *Search {
	s.filterPath = filterPath
	return s
}

// Header adds a header to the request.
func (s *Search) Header(name string, value string) *Search {
	if s.headers == nil {
...
func (s *Search) Headers(headers http.Header) *Search {
	s.headers = headers
	return s
}

// SearchSource sets the search source builder to use with this service.
func (s *Search) SearchSource(searchSource *SearchSource) *Search {
...
func (s *Search) Source(source interface{}) *Search {
	s.source = source
	return s
}

// Index sets the names of the indices to use for search.
func (s *Search) Index(index ...string) *Search {
...
func (s *Search) Type(typ ...string) *Search {
	s.typ = append(s.typ, typ...)
	return s
}

// Timeout sets the timeout to use, e.g. "1s" or "1000ms".
func (s *Search) Timeout(timeout string) *Search {
...
// profiling data.
func (s *Search) Profile(profile bool) *Search {
	s.searchSource = s.searchSource.Profile(profile)
	return s
}

// Collapse adds field collapsing.
func (s *Search) Collapse(collapse *CollapseBuilder) *Search {
...
// of this search.
func (s *Search) PointInTime(pointInTime *PointInTime) *Search {
	s.searchSource = s.searchSource.PointInTime(pointInTime)
	return s
}

// RuntimeMappings specifies optional runtime mappings.
func (s *Search) RuntimeMappings(runtimeMappings RuntimeMappings) *Search {
	s.searchSource = s.searchSource.RuntimeMappings(runtimeMappings)
	return s
}

// TimeoutInMillis sets the timeout in milliseconds.
func (s *Search) TimeoutInMillis(timeoutInMillis int) *Search {
...
func (s *Search) TerminateAfter(terminateAfter int) *Search {
...
// for details.
func (s *Search) SearchType(searchType string) *Search {
...
func (s *Search) Routing(routings ...string) *Search {
...
func (s *Search) Preference(preference string) *Search {
...
func (s *Search) RequestCache(requestCache bool) *Search {
	s.requestCache = &requestCache
	return s
}

// Query sets the query to perform, e.g. MatchAllQuery.
func (s *Search) Query(query Query) *Search {
...
func (s *Search) PostFilter(postFilter Query) *Search {
...
func (s *Search) FetchSource(fetchSource bool) *Search {
	s.searchSource = s.searchSource.FetchSource(fetchSource)
	return s
}

// FetchSourceContext indicates how the _source should be fetched.
func (s *Search) FetchSourceContext(fetchSourceContext *FetchSourceContext) *Search {
	s.searchSource = s.searchSource.FetchSourceContext(fetchSourceContext)
	return s
}

// Highlight adds highlighting to the search.
func (s *Search) Highlight(highlight *Highlight) *Search {
...
func (s *Search) GlobalSuggestText(globalText string) *Search {
	s.searchSource = s.searchSource.GlobalSuggestText(globalText)
	return s
}

// Suggester adds a suggester to the search.
func (s *Search) Suggester(suggester Suggester) *Search {
	s.searchSource = s.searchSource.Suggester(suggester)
	return s
}

// Aggregation adds an aggreation to perform as part of the search.
func (s *Search) Aggregation(name string, aggregation Aggregation) *Search {
...
func (s *Search) Explain(explain bool) *Search {
...
func (s *Search) Version(version bool) *Search {
	s.searchSource = s.searchSource.Version(version)
	return s
}

// Sort adds a sort order.
func (s *Search) Sort(field string, ascending bool) *Search {
	s.searchSource = s.searchSource.Sort(field, ascending)
	return s
}

// SortWithInfo adds a sort order.
func (s *Search) SortWithInfo(info SortInfo) *Search {
	s.searchSource = s.searchSource.SortWithInfo(info)
	return s
}

// SortBy adds a sort order.
func (s *Search) SortBy(sorter ...Sorter) *Search {
...
func (s *Search) DocvalueField(docvalueField string) *Search {
...
// and return as part of the search.
func (s *Search) DocvalueFieldWithFormat(docvalueField DocvalueField) *Search {
...
// and return as part of the search.
func (s *Search) DocvalueFields(docvalueFields ...string) *Search {
...
// and return as part of the search.
func (s *Search) DocvalueFieldsWithFormat(docvalueFields ...DocvalueField) *Search {
...
func (s *Search) NoStoredFields() *Search {
...
func (s *Search) StoredField(fieldName string) *Search {
...
func (s *Search) StoredFields(fields ...string) *Search {
...
func (s *Search) TrackScores(trackScores bool) *Search {
...
// for details.
func (s *Search) TrackTotalHits(trackTotalHits interface{}) *Search {
...
func (s *Search) SearchAfter(sortValues ...interface{}) *Search {
...
func (s *Search) DefaultRescoreWindowSize(defaultRescoreWindowSize int) *Search {
	s.searchSource = s.searchSource.DefaultRescoreWindowSize(defaultRescoreWindowSize)
	return s
}

// Rescorer adds a rescorer to the search.
func (s *Search) Rescorer(rescore *Rescore) *Search {
...
func (s *Search) IgnoreUnavailable(ignoreUnavailable bool) *Search {
...
func (s *Search) IgnoreThrottled(ignoreThrottled bool) *Search {
...
func (s *Search) AllowNoIndices(allowNoIndices bool) *Search {
...
func (s *Search) ExpandWildcards(expandWildcards string) *Search {
...
func (s *Search) Lenient(lenient bool) *Search {
	s.lenient = &lenient
	return s
}
...
func (s *Search) MaxResponseSize(maxResponseSize int64) *Search {
...
func (s *Search) AllowPartialSearchResults(enabled bool) *Search {
...
func (s *Search) BatchedReduceSize(size int) *Search {
...
func (s *Search) MaxConcurrentShardRequests(max int) *Search {
...
func (s *Search) PreFilterShardSize(threshold int) *Search {
...
func (s *Search) RestTotalHitsAsInt(enabled bool) *Search {
...
func (s *Search) CCSMinimizeRoundtrips(enabled bool) *Search {
	s.ccsMinimizeRoundtrips = &enabled
	return s
}

// buildURL builds the URL for the operation.
func (s *Search) buildURL() (string, url.Values, error) {
	var err error
	var path string
...
type SearchHit struct {
	...
	Version        *int64                         `json:"_version,omitempty"` // version number, when Version is set to true in Search
