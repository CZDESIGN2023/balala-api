...
const (
	Login_Login_FullMethodName             = "/api.login.v1.Login/Login"
	Login_GetLoginValidCode_FullMethodName = "/api.login.v1.Login/GetLoginValidCode"
	Login_Logout_FullMethodName            = "/api.login.v1.Login/Logout"
)
...
type LoginClient interface {
	...
	GetLoginValidCode(ctx context.Context, in *GetLoginValidCodeRequest, opts ...grpc.CallOption) (*GetLoginValidCodeReply, error)
	Logout(ctx context.Context, in *DoLogoutRequest, opts ...grpc.CallOption) (*comm.CommonReply, error)
}
...
func (c *loginClient) GetLoginValidCode(ctx context.Context, in *GetLoginValidCodeRequest, opts ...grpc.CallOption) (*GetLoginValidCodeReply, error) {
	out := new(GetLoginValidCodeReply)
	err := c.cc.Invoke(ctx, Login_GetLoginValidCode_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loginClient) Logout(ctx context.Context, in *DoLogoutRequest, opts ...grpc.CallOption) (*comm.CommonReply, error) {
...
func (UnimplementedLoginServer) GetLoginValidCode(context.Context, *GetLoginValidCodeRequest) (*GetLoginValidCodeReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLoginValidCode not implemented")
}
func (UnimplementedLoginServer) Logout(context.Context, *DoLogoutRequest) (*comm.CommonReply, error) {
...
func _Login_GetLoginValidCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLoginValidCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoginServer).GetLoginValidCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Login_GetLoginValidCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServer).GetLoginValidCode(ctx, req.(*GetLoginValidCodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Login_Logout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServer).Logout(ctx, req.(*DoLogoutRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Login_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLoginValidCode",
			Handler:    _Login_GetLoginValidCode_Handler,
		},
		{
			MethodName: "Logout",
